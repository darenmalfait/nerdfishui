...
export const buttonVariants = cva(
	'inline-flex items-center relative focus-outline justify-center rounded-md border text-sm font-medium transition-all active:scale-95 disabled:pointer-events-none',
	{
		variants: {
			variant: {
				default:
