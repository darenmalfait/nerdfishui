...
>(({asChild, className, ...props}, ref) => {
  ...
  return (
    <Comp
      ref={ref}
      className={cx('transition-colors hover:text-primary', className)}
      {...props}
    />
  )
})
...
>(({className, ...props}, ref) => (
  <span
    ...
    aria-disabled="true"
    aria-current="page"
    className={cx('font-normal text-primary', className)}
    {...props}
  />
))
...
const Breadcrumb = Object.assign(BaseBreadcrumb, {
  List: BreadcrumbList,
  Item: BreadcrumbItem,
  Link: BreadcrumbLink,
  Page: BreadcrumbPage,
