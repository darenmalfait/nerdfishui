...
export interface MultiEmailRootProps
...
export const MultiEmailRoot = React.forwardRef<
	HTMLInputElement,
	MultiEmailRootProps
>(function MultiEmailRoot(
	{
		value: valueProp,
		emails: emailsProp,
		className,
...
MultiEmailRoot.displayName = 'MultiEmailRoot'

export const MultiEmail = React.forwardRef<
	HTMLInputElement,
	InputProps & MultiEmailRootProps
>(function Input(
...
export type MultiEmailProps = React.ComponentPropsWithoutRef<typeof MultiEmail>
