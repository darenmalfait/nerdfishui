...
export const buttonVariants = cva(
	'inline-flex px-[0.625em] py-[0.5em] items-center relative focus-outline justify-center rounded-base border text-sm font-medium transition-all active:scale-95 disabled:pointer-events-none',
	{
		variants: {
			variant: {
				default:
