	...
	return (
		<span className="animate-shake repeat-infinite [animation-duration:4s]">
			<svg
				...
				viewBox="0 0 912 421"
				className={cx(
					'direction-reverse animate-squeeze repeat-infinite rounded-container fill-current [animation-duration:2s]',
					className,
				)}
				{...props}
			>
...
>(function Square({ className, ...props }, ref) {
	return (
		<div
			className={cx(
				'animate-loader border-muted rounded-container relative overflow-hidden border-4',
				className,
			)}
			ref={ref}
			{...props}
