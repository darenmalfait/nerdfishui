...
export const ResizableHandle = ({
	...
	<ResizablePrimitive.PanelResizeHandle
		className={cx(
			'bg-inverted/50 focus-visible:ring-ring relative my-3 flex min-w-1.5 items-center justify-center rounded-3xl opacity-50 after:absolute after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2 hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-1',
			// horizontal
