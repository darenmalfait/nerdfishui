...
- Updated dependency `@tailwindcss/typography` to `^0.5.13`.
  ([#154](https://github.com/darenmalfait/nerdfishui/pull/154))

  Updated dependency `styled-jsx` to `^5.1.3`. Updated dependency `tailwindcss`
  to `^3.4.3`. Updated dependency `tailwind-merge` to `^2.3.0`.
...
- [`7bfc30f`](https://github.com/darenmalfait/nerdfishui/commit/7bfc30f3d3695aab91674a2ed48fb2944a5d59f2)
  Thanks [@darenmalfait](https://github.com/darenmalfait)! - style(global): set
  secondary color
...
- [`df2ca20`](https://github.com/darenmalfait/nerdfishui/commit/df2ca2077b8045ffd26563874a277b9721f07303)
  Thanks [@darenmalfait](https://github.com/darenmalfait)! - add new jump
  animations
