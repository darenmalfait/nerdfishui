	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					'duration-fast relative w-(--sidebar-width) bg-transparent transition-[width] ease-linear',
			...
			<div
				...
				className={cn(
					'duration-fast fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] ease-linear md:flex',
					side === 'left'
...
export function SidebarGroupLabel({
	...
	return useRender({
		...
		props: {
			...
			className: cn(
				'text-sidebar-foreground/70 ring-sidebar-ring rounded-compact px-best-friends duration-fast flex h-8 shrink-0 items-center text-xs font-medium outline-hidden transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
