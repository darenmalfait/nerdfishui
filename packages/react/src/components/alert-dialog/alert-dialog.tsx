...
export function AlertDialogOverlay({
	...
	return (
		<AlertDialogPrimitive.Backdrop
			...
			className={cn(
				'duration-fast fixed inset-0 bg-black/50 transition-all ease-out data-ending-style:opacity-0 data-starting-style:opacity-0',
				className,
			)}
			{...props}
		/>
		...
		<AlertDialogPortal>
			...
			<AlertDialogPrimitive.Popup
				...
				className={cn(
					...
					'rounded-container gap-friends p-friends border-border border shadow-lg outline-none sm:max-w-128 sm:scale-[calc(1-0.1*var(--nested-dialogs))]',
					'duration-fast',
