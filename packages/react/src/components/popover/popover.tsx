		...
		<PopoverPortal>
			<PopoverPositioner sideOffset={sideOffset} align={align} side={side}>
				<PopoverPrimitive.Popup
					...
					className={cx(
						'bg-popover text-popover-contrast outline-border rounded-popover p-popover z-50 w-72 origin-(--transform-origin) shadow-md outline -outline-offset-1 transition-[transform,scale,opacity] data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0',
						className,
					)}
					{...props}
				>
