// https://github.com/calcom/cal.com/blob/d1810d9f1413a55f2de3af453a9cef1b22a6521b/packages/lib/slugify.ts
...
export function slugify(str: string, forDisplayingInput?: boolean) {
	if (!str) {
		return ''
	}
	const s = str
