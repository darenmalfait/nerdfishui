...
function AppDemo() {
	return (
		<div className="bg-accent rounded-large hidden xl:block">
			<div className="p-lg">
				<div className="bg-primary rounded-large overflow-hidden shadow-2xl transition-all">
							...
							<div className="px-8 py-6">
								<Tabs defaultValue="recipes" className="h-full space-y-6">
									...
									>
										...
										<div className="border-muted rounded-large flex h-[450px] min-h-0 shrink-0 items-center justify-center border border-dashed">
...
function AlbumArtwork({
	...
	return (
		<div className={cx('group space-y-3', className)} {...props}>
			<div className="rounded-large object-cover">
				<AspectRatio ratio={aspectRatio === 'square' ? 1 : 3 / 4}>
					<Image
						src={album.cover}
						alt={album.name}
						fill
						className="focus-ring rounded-large object-cover transition-all"
					/>
				</AspectRatio>
			</div>
