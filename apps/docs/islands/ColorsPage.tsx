...
import { ColorPalette } from '../lib/tokens/colors/color-palette'
import { type ColorPalette as ColorPaletteType } from '../lib/tokens/colors/types'
	...
	},
	{
		...
		colors: [
			...
			},
			{
				...
				variable: 'var(--color-foreground-body)',
				foreground: 'var(--color-foreground-inverted)',
			},
			{
				name: 'foreground-headline',
				className: 'text-foreground-headline',
				variable: 'var(--color-foreground-headline)',
				foreground: 'var(--color-foreground-inverted)',
			},
			{
				name: 'foreground-subtitle',
				className: 'text-foreground-subtitle',
				variable: 'var(--color-foreground-subtitle)',
				foreground: 'var(--color-foreground-inverted)',
			},
			{
				name: 'foreground-label',
				className: 'text-foreground-label',
				variable: 'var(--color-foreground-label)',
				foreground: 'var(--color-foreground-inverted)',
			},
			{
				name: 'foreground-subtle',
				className: 'text-foreground-subtle',
				variable: 'var(--color-foreground-subtle)',
				foreground: 'var(--color-foreground-inverted)',
			},
			{
				name: 'foreground-link',
				className: 'text-foreground-link',
				variable: 'var(--color-foreground-link)',
				foreground: 'var(--color-info-contrast)',
			},
		],
	},
	{
		...
		colors: [
			...
			},
			{
				...
				variable: 'var(--color-background-surface)',
				foreground: 'var(--color-foreground)',
			},
			{
				name: 'background-surface-muted',
				className: 'bg-background-surface-muted',
				variable: 'var(--color-background-surface-muted)',
				foreground: 'var(--color-foreground)',
			},
			{
				name: 'background-surface-secondary',
				className: 'bg-background-surface-secondary',
				variable: 'var(--color-background-surface-secondary)',
				foreground: 'var(--color-foreground)',
			},
			{
				name: 'background-overlay',
				className: 'bg-background-overlay',
				variable: 'var(--color-background-overlay)',
				foreground: 'var(--color-foreground)',
			},
			{
				name: 'background-overlay-muted',
				className: 'bg-background-overlay-muted',
				variable: 'var(--color-background-overlay-muted)',
				foreground: 'var(--color-foreground)',
			},
			{
				name: 'background-overlay-secondary',
				className: 'bg-background-overlay-secondary',
				variable: 'var(--color-background-overlay-secondary)',
				foreground: 'var(--color-foreground)',
			},
		],
	},
