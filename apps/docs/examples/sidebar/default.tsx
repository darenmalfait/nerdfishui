			...
			<SidebarProvider className="min-h-125!">
												...
												<CollapsibleTrigger
													render={
														<SidebarMenuButton tooltip={item.title}>
															...
															<ChevronRight className="duration-fast ml-auto transition-transform group-data-[state=open]/collapsible:rotate-90" />
														</SidebarMenuButton>
													}
												/>
												<CollapsibleContent>
				...
				<SidebarInset>
					...
					<div className="flex flex-1 flex-col gap-4 p-4 pt-0">
						...
						<div className="bg-background-muted/50 min-h-min flex-1 rounded-xl" />
					</div>
				</SidebarInset>
			</SidebarProvider>
		</div>
